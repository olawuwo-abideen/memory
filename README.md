# memory
A memories keeping app built on express, body-parser, ejs, mongoose, session, passport and PassportLocalMongoose

## Installation

The code for the chat app can be found at the public [GitHub](https://github.com/olawuwo-abideen/memory). Either clone the repo to a local folder on your machine or
